...
const treinoName = getElement<HTMLHeadingElement>(
    "treino-name"
);
...
const exerciciosList = getElement<HTMLElement>(
    "exercicios-list"
);
...
function createExerciseCard(
    ...
    meta.append(
        createMetaBox(
            "Músculo",
            treinoExercicio.musculo_trabalhado
        ),
        createMetaBox(
            "Séries",
            String(treinoExercicio.qtd_series)
        ),
        createMetaBox(
            "Repetições",
            String(treinoExercicio.qtd_repeticoes)
        )
    );
...
function configureBackLink(): void {
